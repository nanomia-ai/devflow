# Failure and unverified routing
...
Repair-lineage selection is deterministic only when the current labels resolve to one root.
Ambiguous or unparsable roots stop execution and report the exact label and candidates; an
interruption after a committed result resumes its route without rerunning the verifier.
