...
export const OBSERVATIONS = {
  ...
  "state.compatibleWriter": { collector: "state.compatible-writer", domain: ["none", "product", "design", "arch", "adopt", "invalid"] }
};
...
export const STAGES = [
  { id: "recovery-action", reads: ["state.canonicalNext"], acceptsUnknown: [], done: s => !["marker.design-note", "marker.design-open-item", "baseline.boundary", "layer.folder-boundary", "ready.digest-behind"].includes(s.state.canonicalNext), table: "recovery", reentry: "rejudge", branches: { "route-arch": [["READ", { artifact: "cards" }], ["READ", { path: "references/recovery-policy.md" }], "ROUTE:arch"], "route-adopt": [["READ", { artifact: "cards" }], ["READ", { path: "references/recovery-policy.md" }], "ROUTE:adopt"], "finish-baseline-boundary": [["READ", { artifact: "cards" }], ["READ", { path: "references/recovery-policy.md" }], ["COMMIT", { boundary: "baseline" }], "WAIT"], "commit-folder-boundary": [["READ", { artifact: "cards" }], ["READ", { path: "references/recovery-policy.md" }], ["COMMIT", { boundary: "folder" }], "WAIT"], "commit-digest": [["READ", { artifact: "digest" }], ["READ", { path: "references/recovery-policy.md" }], ["COMMIT", { boundary: "digest" }], "WAIT"] }, body: "stage: recovery-action" },
  { id: "scope-entry", reads: [], acceptsUnknown: [], done: () => false, needs: ["intent.scope"], table: "canonicalNext", branches: { "DONE:orientation": [["REPORT", { template: "orientation" }], "DONE"], "DONE:unmanaged": [["REPORT", { template: "result", scope: "unmanaged-repository" }], "DONE"], "ASK:integrity": ["ASK"], "ASK:setup": ["ASK"], "ASK:owner-mapping": ["ASK"], "compatible-product": ["ROUTE:product"], "compatible-design": ["ROUTE:design"], "compatible-arch": ["ROUTE:arch"], "compatible-adopt": ["ROUTE:adopt"], "ROUTE:product": ["ROUTE:product"], "ROUTE:arch": ["ROUTE:arch"], "ROUTE:adopt": ["ROUTE:adopt"], "ROUTE:split": ["ROUTE:split"], "ROUTE:work": ["ROUTE:work"], "ROUTE:verify": ["ROUTE:verify"], "WAIT:blocked": [["REPORT", { template: "result" }], "WAIT"], "DONE:advisory": [["REPORT", { template: "result" }], "DONE"], "DONE:complete": [["REPORT", { template: "result" }], "DONE"], "BLOCK:unrecognized": ["BLOCK"] }, reentry: "rejudge", body: "stage: scope-entry" }
];
export const TABLES = { recovery: { reads: ["state.canonicalNext"], rows: [
  ...
  { state: "compatible-adopt", reads: ["state.canonicalNext", "state.compatibleWriter"], acceptsUnknown: [], when: s => s.state.canonicalNext === "marker.compatible-feedback" && s.state.compatibleWriter === "adopt" },
