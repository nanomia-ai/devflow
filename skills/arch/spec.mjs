...
export const STAGES = [
  ...
  { id: "knowledge-landing", reads: ["marker.knowledge", "marker.knowledgeCount"], acceptsUnknown: [], done: s => s.marker.knowledge === "none" && s.marker.knowledgeCount === 0, needs: ["landing.mode"], reentry: "rejudge", branches: {
    ...
    recursive: [["READ", { path: "references/knowledge-landing.md" }], ["WRITE", { artifact: "knowledgeNodes", template: "knowledgeNode" }], ["RUN", { action: "validate exact selected knowledge/K paths" }], ["RUN", { action: "delete-only-consumed-owner-marker" }], ["COMMIT", { boundary: "atomic-knowledge-landing" }], "NEXT"],
    ...
    "partial-recursive": [["READ", { path: "references/knowledge-landing.md" }], ["WRITE", { artifact: "knowledgeNodes", template: "knowledgeNode" }], ["RUN", { action: "validate exact selected knowledge/K paths" }], ["RUN", { action: "delete-selected-owner-markers-and-preserve-residual-markers" }], ["COMMIT", { boundary: "atomic-partial-knowledge-landing" }], "NEXT"],
    "multi-mixed": [["READ", { path: "references/knowledge-landing.md" }], ["WRITE", { artifact: "knowledgeOwnerScope", template: "result" }], ["WRITE", { artifact: "knowledgeNodes", template: "knowledgeNode" }], ["RUN", { action: "validate exact selected knowledge/K paths" }], ["RUN", { action: "delete-exactly-consumed-marker-set" }], ["COMMIT", { boundary: "atomic-multi-owner-knowledge-landing" }], "NEXT"]
  ...
  { id: "capability-design", reads: ["state.capabilities", "state.expected"], acceptsUnknown: [], done: s => s.state.capabilities === "current" || s.state.expected === 0, needs: ["capability.action", "route.after"], table: "capabilityRoute", reentry: "rejudge", branches: {
    ...
    "approve-design": [["WRITE", { artifact: "capabilityDesignZones", template: "capabilityDesign" }], ["WRITE", { artifact: "knowledgeNodes", template: "knowledgeNode" }], ["RUN", { action: "validate exact changed capability/K paths" }], ["COMMIT", { boundary: "capability-design" }], "ROUTE:design"],
    "approve-resume": [["WRITE", { artifact: "capabilityDesignZones", template: "capabilityDesign" }], ["WRITE", { artifact: "knowledgeNodes", template: "knowledgeNode" }], ["RUN", { action: "validate exact changed capability/K paths" }], ["COMMIT", { boundary: "capability-design" }], "ROUTE:resume"],
    "approve-direct": [["WRITE", { artifact: "capabilityDesignZones", template: "capabilityDesign" }], ["WRITE", { artifact: "knowledgeNodes", template: "knowledgeNode" }], ["RUN", { action: "validate exact changed capability/K paths" }], ["COMMIT", { boundary: "capability-design" }], "ROUTE:direct"]
