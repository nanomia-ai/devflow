...
const required = [
  "entry-initial", "trace-needed", "approval-refuse", "proposal-interrupted", "no-code", "capability-split",
  "landing-compact", "landing-recursive", "landing-partial-compact", "integrity-block", "trace-inconsistent"
];
...
await access(new URL("projects/knowledge-landing/cards/01.1-research.md", import.meta.url));
