...
const data = [
  ...
  fixture("approval-approve", { judged: { "refutation.state": "clear" }, decided: { "approval.action": "approve" } }, { stage: "adoption", row: "approve", status: "DONE", effects: ["WRITE", "WRITE", "WRITE", "WRITE", "RUN", "WRITE", "WRITE", "RUN", "WRITE", "WRITE", "RUN", "RUN", "COMMIT", "RUN", "WRITE", "COMMIT", "REPORT", "DONE"] }, ["row:approval/approve", "branch:approval/approve"])
];
