...
Observations: state kernel, route, current tracked-plus-untracked non-devflow material presence, four-state bounded refutation, and binding approval.
...
Consumers: the clean refuter receives the full draft, knowledge unit dispositions and exact landing targets, load-bearing current and proposed coordinates, the same shared baseline and knowledge sections opened by workflow step 5, and only the Surface and Required channel columns plus first proposal paragraph and ADR conditions from `<skill-root>/../arch/references/workflow.md`. Arch reads Layer 0 and capability zones; Direct reads product and architecture; Work and Resume read capability and knowledge documents.
