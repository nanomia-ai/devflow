...
Ownership: spec owns routing and exact machine forms; body owns judgment reasons; templates own output grammar; selected references own topic policy; sibling state tools own deterministic project facts.
