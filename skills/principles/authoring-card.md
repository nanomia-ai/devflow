...
Ownership: spec owns routing and exact machine forms; body owns judgment reasons; templates own output grammar; selected references own topic policy, including input-owner K discovery and the shared owner/K approval and physical-writer boundaries; sibling state tools own deterministic project facts.
