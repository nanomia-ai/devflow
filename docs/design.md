...
| `adopt` | transiently accounts for all maintained brownfield sources, proposes the Working language from meaningful human prose, and transfers their durable meaning into self-contained Product, Architecture, applicable Design, code style, glossary, capability design zones, and owner-adjacent K without retaining absorbed inputs as current dependencies | unmanaged documents and/or code → an independently maintainable managed planning and knowledge surface plus the `product.md` Working language; a whole follow-on goes through the journal to direct, otherwise stop | DD-10 · DD-20 · DD-26 · DD-97 · DD-107 · DD-108 · DD-109 · DD-110 |
