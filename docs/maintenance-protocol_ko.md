...
`node --test "scripts/*.test.js" "skills/**/*.test.mjs"`가 위 선언 쌍의 구조·기계 수치 대응과 영어 배포 안내의 한국어
...
시험 초록만으로 지나가는 동안 신규 프로젝트는 첫 Direct 진입에서 멈춰 있었다. 관문 B의 사양과
