...
The Codex prompt folder is flat; relative references are unreliable
...
Subject: Identity, packaging, platforms | Introduced: v0.9.9 | State: active
...
Subject: The task tree and its cards | Introduced: v0.14.0 | State: active
